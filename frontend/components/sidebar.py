...
def render_sidebar(active_tip: int = 0) -> str:
    ...
    logo_svg = (
        '<svg class="sidebar-logo-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">'
    ...
    hamburger_svg = (
        '<svg class="sidebar-menu-toggle" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">'
    ...
    for i in range(tip_count):
        ...
        dots_html += f'<a class="pagination-dot {active_class}" href="?tip={i}" target="_self"></a>'
    ...
    <div class="sidebar-inner">
        ...
        <div class="quick-tip-card">
            ...
            <div class="quick-tip-footer">
                ...
                <a class="tip-nav-btn" href="?tip={next_idx}" target="_self">Next ➜</a>
            </div>
        </div>
    </div>
    """
