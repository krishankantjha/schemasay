...
Purely presentational natural language SQL generator panel.
All state mutations, URL parameters interception, and API requests are handled by the controller page views.
"""
...
def render_ai_copilot_panel():
    ...
    Presents input widgets, suggestion chips, loading states, and output code blocks.
    """
    ...
    # Handle generation trigger (validation + transition state)
    if generate_clicked:
    ...
    # ── 5. Generated SQL block code previews ──────────────────────────────────
